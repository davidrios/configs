...
vim.keymap.set("n", "<leader>br", "mZ:bd<cr>'Z", { desc = "Reload buffer (to activate LSP)" })
...
if dap then
  ...
  vim.keymap.set("n", "<leader>xdc", function() dap.continue() end, { desc = "DAP: Continue" })
  vim.keymap.set({"n", "i"}, "<F5>", function() dap.continue() end, { desc = "DAP: Continue" })
  vim.keymap.set("n", "<leader>xdo", function() dap.step_over() end, { desc = "DAP: Step over" })
