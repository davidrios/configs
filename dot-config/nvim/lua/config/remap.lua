...
vim.keymap.set("n", "<leader>br", "mZ:bd<cr>'Z:MyUtilsReadUndo<cr>", { desc = "Reload buffer (to activate LSP)" })
vim.keymap.set("n", "<leader>bR", "mZ:w<cr>:bd<cr>'Z:MyUtilsReadUndo<cr>", { desc = "Write and reload buffer (to activate LSP)" })
